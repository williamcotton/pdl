...
pub use ir::{
    AggItemIr, BinaryOpIr, BindingIr, ExprIr, NullsOrderIr, PipelineIr, PipelineStartIr, ProgramIr,
    RenameItemIr, SelectItemIr, SinkIr, SortDirectionIr, SortItemIr, SourceIr, StageIr, UnaryOpIr,
};
pub use registry::{
