...
pub use ir::{
    ...
    ContextDeclIr, ContextKindIr, ExprIr, FrameBoundIr, JoinKindIr, MutateItemIr, NullsOrderIr,
    OutputIr, PipelineIr, PipelineStartIr, ProgramIr, RenameItemIr, SelectItemIr, SinkIr,
    SortDirectionIr, SortItemIr, SourceIr, StageIr, UnaryOpIr, WindowFrameIr, WindowSpecIr,
};
pub use registry::{
