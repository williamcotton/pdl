...
pub const FORMATS: &[FormatInfo] = &[
    FormatInfo {
        name: "csv",
        documentation: "CSV with a header row; supported for load, save, and stdout in 0.5.",
        load_supported: true,
        save_supported: true,
    ...
    FormatInfo {
        name: "parquet",
        documentation: "Parquet support is deferred past 0.5.",
    ...
    FormatInfo {
        name: "arrow-file",
        documentation: "Arrow IPC file support is deferred past 0.5.",
        load_supported: false,
        save_supported: false,
        stream_supported: false,
    },
    FormatInfo {
        name: "arrow-stream",
        documentation: "Arrow IPC stream support is deferred past 0.5.",
        load_supported: false,
        save_supported: false,
        stream_supported: false,
    },
    FormatInfo {
        name: "jsonl",
        documentation: "JSON Lines support is deferred past 0.5.",
        load_supported: false,
        save_supported: false,
        stream_supported: false,
    },
